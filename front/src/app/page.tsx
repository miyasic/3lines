...
import { GET_SUMMARY, INPUT_URL, MORE, REGISTER_SUMMARY, SUMMARY_LIST } from '@/constants/constantsTexts';
  ...
  return (
    ...
    <div className="pageContainer" style={{ maxWidth: PAGE_MAX_WIDTH }}>
      ...
      <main className={styles.mainContent}>
        ...
        {!state.windowSizeLoading && (
          <AppButton title={MORE} onClick={() => router.push('/list')} isLoading={state.fetchSummariesLoading} />
        )}
      </main>
